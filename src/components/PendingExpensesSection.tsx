                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Cột phải: Dư nợ & Mũi tên bung accordion */}
                      <div className="flex items-center gap-2 shrink-0">
                    ...
                    {isExpanded && (
                      <div className="border-t border-[#F5F3EF] bg-[#FAF9F6]/80 px-3 py-2.5 animate-in fade-in duration-150 space-y-2.5">
                        {cardTxs.length === 0 ? (
                          <div className="py-2.5 text-center flex items-center justify-center gap-1.5 text-xs text-[#059669] font-medium">
                            <CheckCircle2 className="w-4 h-4" />
                            <span>Thẻ đã được tất toán toàn bộ</span>
                          </div>
                        ) : (
                          <>
                            ...
                            {/* Nút Quyết toán thẻ đặt ở chân danh sách chi tiết */}
                            {hasAnyBalance && (
                              <div className="pt-2 border-t border-[#E6E2DA]/60">
                                <button
                                  type="button"
                                  onClick={(e) => handleOpenSettleSheet(e, group)}
                                  className="w-full min-h-[40px] py-2.5 px-3 rounded-xl bg-[#0F3D39] hover:bg-[#134E48] text-white text-xs font-bold flex items-center justify-center gap-1.5 transition-all shadow-2xs cursor-pointer active:scale-[0.99]"
                                >
                                  <Check className="w-3.5 h-3.5 stroke-[2.5]" />
                                  <span>
                                    Quyết toán thẻ {card.name} ({formatVND(hasStatementDue ? statementAmount : nextCycleAmount)})
                                  </span>
                                </button>
                              </div>
                            )}
